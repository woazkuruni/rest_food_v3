# 🍽️ Velora — Restaurant Food Ordering & Management System

A responsive full-stack restaurant food ordering and management system built with **PHP, MySQL, HTML, CSS, and JavaScript**.

Velora provides a complete customer ordering experience together with a dedicated admin panel for managing foods, categories, customers, coupons, reviews, inventory, orders, and payments.
